...
<html lang="pt-BR">
    ...
    <body>
        ...
        <main class="pagina_avaliar">
        	<h1 class="titulo">Avalie esta oficina</h1>
        	<form>
                <div class="formulario_avaliar">
            		<div class="nota_geral">
            			...
            			<textarea class="campo_texto campo_grande" type="text" name="texto"></textarea>
            		</div>
            		<div class="detalhes_da_nota">
        		...
        		<button class="botao_enviar">Avaliar</button>
        	</form>
        </main>
    </body>
</html>
